...
public class IdeaControllerTest {
  ...
  public void givenIdShouldGetIdea() throws Exception {
    when(ideaService.getIdeaById(anyInt())).thenReturn(idea);
    mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/idea/3")
      .contentType(MediaType.APPLICATION_JSON).content(asJsonString(idea)))
  ...
  public void givenIdShouldDeleteIdeaById() throws Exception {
    when(ideaService.deleteIdeaById(anyInt())).thenReturn(idea);
    mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/idea/3")
      .contentType(MediaType.APPLICATION_JSON).content(asJsonString(idea)))
